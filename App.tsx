...
const App: React.FC = () => {
  ...
  return (
    <Router>
      <div className="flex h-[100dvh] bg-white text-[#004A74] overflow-hidden">
        {isMobileSidebarOpen && (
          <div 
        ...
        <button 
          ...
          className={`fixed bottom-6 right-6 lg:hidden z-[90] w-16 h-16 bg-transparent flex items-center justify-center p-1 transition-all duration-300 rounded-full outline-none focus:outline-none hover:scale-110 active:scale-95 ${!isMobileSidebarOpen ? 'animate-xeenaps-bounce' : ''}`}
        >
          <img 
